...
<body>
    <div class="container">
        <div class="row text-center ">
            <div class="col-md-12">
                <br /><br />
             <h2 style="font-family:algerian" class="judul" ><strong>Welcome Admin To Jje Store</strong></h2>
                        ...
                        <strong>Silahkan Masukkan Username dan Password </strong>  
                            ...
                            <div class="panel-body">
                                <form role="form" method="post">
                                     ...
                                     <br>
                                     <h15>Sebagai Pelanggan?<a href="../login.php" class="btn btn-link">Pelanggan</h15></a> 
                                    <hr/>
                                    ...
                                    if(isset($_POST['login']))
                                    {
                                       ...
                                       else
                                       {
                                         ...
                                         <script type="text/javascript">
                                                alert("Login Gagal Harap Masukan Username/Password Yang Benar ")
